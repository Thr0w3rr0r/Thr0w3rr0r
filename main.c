...
#include <unistd.h>
#include <stdbool.h>
//#include "sepol/policydb.c"
//#include "sepol/services.c"
//#include "conditional.c"
//#include "sepol/hashtab.c"
#include "kallsyms.c"
#include "kernel_rw.c"
#include "bad_binder.c"
#include "dac_bypass.c"
#include "knox_bypass.c"
#include "selinux_bypass.c"
#pragma lib libsepol.a
...
/*
    while((iOpt = getopt(argc, argv, "sp:r:")) != -1)
    {
       ...
       //         break;
   //         case 'p':
              pszSepolicyPath ="/system"; //optarg;
      //          break;
   //         case 'r':
                pszRootExecPath = "/system";//optarg;
     //           break;
 //           default:
  //              show_usage();
       //         goto done;
